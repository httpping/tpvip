...
import static com.tp.api.constant.ReturnCodeEnum.CODE_500;
...
public class DemoControl {
    ...
    @HystrixCommand(fallbackMethod = "onError",
            threadPoolKey ="DemoControl",
            groupKey = "DemoControl",
            commandProperties = {
    ...
    public BaseResponse sayHello() throws NotFoundException {
        ...
        try {
            MyWebSocket.sendInfo(demo,null);
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        throw  new NotFoundException(msg1);
    ...
    public BaseResponse onError() throws NotFoundException {
        return BaseResponse.created(CODE_500.ordinal(), CODE_500.getValue());
    }
}