...
import com.tp.api.entity.enums.AgeEnum;
import com.tp.api.entity.enums.PhoneEnum;
import com.tp.api.service.IUserService;
import com.tp.common.bean.BasePageResult;
...
public class UserController {
     ...
     */
    @GetMapping("/test")
    public BasePageResult<User> test() {
        return BasePageResult.created( userService.selectPage(new Page<User>(0, 12)));
    }
